...
namespace Scoz.Func
{
    public static class UIExtensions
    {
        ...
        public static void ScrollToCeneter_Verticle(this ScrollRect scrollRect, RectTransform target)
        {
        ...
        public static void ScrollToCenter_Horizontal(this ScrollRect scrollRect, RectTransform target, RectTransform.Axis axis = RectTransform.Axis.Vertical)
        {
            // The scroll rect's view's space is used to calculate scroll position
